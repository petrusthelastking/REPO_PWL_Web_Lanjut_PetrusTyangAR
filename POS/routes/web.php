...
Route::middleware(['auth'])->group(function () { // artinya semua route di dalam group ini harus login dulu
    ...
    Route::middleware(['auth'])->group(function () { // artinya semua route di dalam group ini harus login dulu
        ...
        Route::middleware(['authorize:ADM,MMG'])->group(function(){ // artinya semua route di dalam group ini harus punya role ADM (Administrator) dan MNG (Manager) dan STF (Staff)
        ...
        Route::middleware(['authorize:ADM,MMG'])->group(function(){ // artinya semua route di dalam group ini harus punya role ADM (Administrator) dan MNG (Manager)
