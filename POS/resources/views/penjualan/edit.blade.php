    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('penjualan/'.$penjualan->penjualan_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="datetime-local" class="form-control" id="tanggal_penjualan" name="tanggal_penjualan" value="{{ old('tanggal_penjualan', date('Y-m-d\TH:i', strtotime($penjualan->tanggal_penjualan))) }}" required>
